! This program executes "pow" as a test program using the LC-5200b ISA
...
! 22 Instructions before this

RET0:
        add $v0, $zero, $zero                   ! return a value of 0
        beq $zero, $zero, FIN                   ! unconditional branch to FIN

! 24 Instructions before this
...
! 50 instructions before this

RET:
        jalr $ra, $zero                         ! return from mult

! 51 instructions before this
